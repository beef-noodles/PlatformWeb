  ...
  render() {
    return (
      <Tooltip placement={this.state.placement!} title={this.state.tips!}>
        <img className='gisBaseTool' src={this.state.imgPath} alt={this.state.tips!} onClick={this.clickHandle.bind(this)}/>
      </Tooltip>
      // <img className='gisBaseTool' src={this.state.imgPath} alt={this.state.tips!} title={this.state.tips!} onClick={this.clickHandle.bind(this)}/>
    )
  }
}
